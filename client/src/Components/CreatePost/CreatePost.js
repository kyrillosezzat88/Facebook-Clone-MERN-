    ...
    return(
        <Box className="CreatePost" >
            <Box className="post" onClick={(e) => e.stopPropagation()}>
                ...
                <textarea className={lang === 'AR'&&"ArContent"} rows={6}  defaultValue={Data&&Data.content} placeholder="whats in your mind, kyrillos? " cols="66"  onChange={(e) => addContent(e.target.value)} />
